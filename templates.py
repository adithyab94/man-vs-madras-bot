...
"Witnessed a fight between [cult_] and [cult_2]",
"Last night made it to [chennai_landmark]. It was occupied by some poeple. They were kind",
...
"remembering a time when [tn_place] was great place and just not a [post_apoc_waste]",
...
"[cult_] and [cult_2] are having a huge party. I can hear them playing [tamil_dance_number]. [ques_engaging]",
...
"Met a [gender_] who promised me [rare_stuff] if I find him [nostalgic_thing]",
...
"Met a [tn_place] [gender_] who warned me about a possible war between [cult_] and [cult_2]",
"I feel like wearing [dress_] today",
"A survivor warned me not to got [chennai_landmark] as it is full of [violent_being]. But I am, wish me luck",
"My search for [rare_stuff] was intruded by a [violent_being]. Bleeding everywhere, wish me health",
"I miss [current_things]",
"Scavenged [chennai_area] with a [gender_]. Found a huge stash of [alcohol_]. We drank and discussed about [current_things]",
...
"Manslaughterd a [country_p] [gender_] over a fight for [rare_stuff]",
"Fought a bunch of [violent_being] with [cult_]. We split the spoils later",
"Met a scavenger who promised me [nostalgic_thing] if I cook him [food_]",
...
"Met a bunch of kids who think [cult_] is crazy. Lol, Only if they had lived in a time with [current_things]",
...
"Remebering a time when with [current_things]. No wonder the world ended",
...
"Assaulted a [tn_place] [gender_] with [weapon_] after they tried to steal my food",
...
"Sometimes I am jealous of these kids, they dont know a world with [current_things]",
...
"Assaulted a [country_p] [gender_] with [weapon_] after they tried to steal my food",
"Snuck into [chennai_landmark] full of [violent_being]. Found [nostalgic_thing]",
